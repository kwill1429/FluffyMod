...
public class DinLoggerStuff {
	public static void preSwag (){

	       
        System.out.println("Roses are black everything is black");
        System.out.println("I might be blind");
        System.out.println("So quack quack");
